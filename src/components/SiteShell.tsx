...
const CHROMELESS_PREFIXES = ["/campaigns/modelmatch-trial-info", "/campaigns/sales-cycle-shrinkage", "/capabilities", "/modelmatch-deck", "/modelmatch-datalibrary", "/modelmatch-cinematic"];
