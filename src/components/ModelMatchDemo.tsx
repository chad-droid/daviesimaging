...
const rooms = [
  {
    ...
    stages: [
      ...
      },
      {
        ...
        detail: "The bare listing photo is uploaded through FrameFlow Studio. Standard HDR listing photography works perfectly. No special requirements or new shoot needed.",
        tint: "bg-[#EBEBEB]",
        numBg: "bg-[#C0C0C0]",
        numText: "text-[#3A3A3A]",
        accent: false,
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        label: "Vacant Room",
        caption: "Empty listing photo",
        detail: "The vacant primary bedroom, photographed by a DIG listing photographer or sourced from existing inventory photography. Upload directly in FrameFlow Studio.",
        tint: "bg-[#EBEBEB]",
        numBg: "bg-[#C0C0C0]",
        numText: "text-[#3A3A3A]",
        accent: false,
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        label: "Vacant Room",
        caption: "Empty listing photo",
        detail: "An open dining space becomes the canvas. Existing photography or new listing photos both work. Upload through FrameFlow Studio and select your ModelMatch Gallery.",
        tint: "bg-[#EBEBEB]",
        numBg: "bg-[#C0C0C0]",
        numText: "text-[#3A3A3A]",
        accent: false,
