...
// /buildermarketingsummit2026 — the ModelMatch landing page for attendees of
// the Builder Marketing Summit (Dallas, September 23 and 24, 2026), which DIG
// sponsors. Cloned from /shore2026 (itself a clone of /modelmatch-datalibrary:
// same Hormozi cold-traffic architecture and the same free-trial offer, inline
// via MMTrialEmbed at #start) with Summit framing swapped for this event. Per
// Chad, no booth or session presence bar on this page.
//
...
function SummitPill() {
  return (
    ...
    >
      ...
      Builder Marketing Summit 2026 · Attendee Access
    </span>
  );
}
    ...
    <section style={{ position: "relative", padding: "132px 40px 80px", background: CREAM }}>
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <Reveal delay={0.06} style={{ marginTop: 22 }}>
          <Eyebrow>For the people who market, sell, and lead in home building</Eyebrow>
        </Reveal>
        <Reveal delay={0.1}>
          <h1
            style={{
...
export function BuilderMarketingSummit2026() {
  return (
    <div className="mm-lib" data-screen-label="Builder Marketing Summit 2026">
