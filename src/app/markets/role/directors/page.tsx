  ...
  return (
    <>
      ...
      <PainPoints
        ...
        headline={<>The same challenges, every <strong>quarter</strong>.</>}
        points={[
          { title: "Inconsistent Quality", description: "Every community looks different because every photographer shoots differently." },
          { title: "Vendor Overload", description: "Coordinating photography, staging, and video across multiple vendors wastes time and budget." },
          { title: "Assets That Sit", description: "Beautiful photos that only live on the MLS with no strategy for email, paid media, or sales." },
        ]}
      />
      <Solution
        eyebrow="One Partner"
